...
* Lesson 4: Statistical inference
    + [View completed lesson](LESSONS/COMPLETED/Completed_Lesson-04_Statistical-inference.qmd)
    + Downloads:
...
* Lesson 5: Working with messy data
    + [View completed lesson](LESSONS/COMPLETED/Completed_Lesson-05_Working-with-messy-data.qmd)
    + Downloads:
        - [Quarto doc](https://raw.githubusercontent.com/itmat/ITMAT_office_houRs/main/LESSONS/Lesson-05_Working-with-messy-data.qmd) (save to `LESSONS/` subdirectory)

* Lesson 6: Joining tables
    + Downloads:
        - [Quarto doc](https://raw.githubusercontent.com/itmat/ITMAT_office_houRs/main/LESSONS/Lesson-06_Joining-tables.qmd) (save to `LESSONS/` subdirectory)
        - Data files:  (save to `DATA/` subdirectory)
            1. [Clock gene expression table](DATA/bhtc_rnaseq_gene-expression_core-clock-genes_long-format.txt)
            2. [Sample metadata](DATA/bhtc_rnaseq_sample-metadata.txt)
            3. [Gene annotation metadata](DATA/bhtc_rnaseq_gene-metadata_gencode-v23.txt)
